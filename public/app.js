...
/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cart */ "./cart.js");
/* harmony import */ var _checkout__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./checkout */ "./checkout.js");
...
window.products = _products__WEBPACK_IMPORTED_MODULE_3__.default;
window.checkout = _checkout__WEBPACK_IMPORTED_MODULE_2__.default;
...
function cart() {
  return {
    formatPrice: _helpers__WEBPACK_IMPORTED_MODULE_0__.formatPrice,
  ...
  return {
    ...
    checkout: async function () {
      try {
        ...
        const stripe = Stripe(_constants__WEBPACK_IMPORTED_MODULE_0__.STRIPEPK);
        const {
          data
        } = await _http__WEBPACK_IMPORTED_MODULE_1__.default.post(`${_constants__WEBPACK_IMPORTED_MODULE_0__.BASEURL}/checkout`, {
          products,
          secret: _constants__WEBPACK_IMPORTED_MODULE_0__.STRIPESK
        });
...
/*! export STRIPEPK [provided] [no usage info] [missing usage info prevents renaming] */
/*! export STRIPESK [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
...
/* harmony export */   "STRIPEPK": () => /* binding */ STRIPEPK,
/* harmony export */   "STRIPESK": () => /* binding */ STRIPESK
/* harmony export */ });
const BASEURL = "http://localhost:5000";
const STRIPEPK = "pk_test_51HG9eAGz3EyK1lQ9ld9Ora0Q4VCtiLIjVvCP3Y9mgGij4bjHfluVV4JaVZWHavWYiU2LMDo02vcJn3J3qUFTLiOL00zPcHpyiB";
const STRIPESK = "sk_test_51HG9eAGz3EyK1lQ9JStfmcNf3dAmpvGjH1nnijXE4z6x61Nc5PH6mWCBfkgRexZO95t4TRxm943trwT7Tv0N5Asg00IaaS3h5k";
...
function products() {
  return {
    ...
    add: function (product) {
      ...
      const indexProductInCart = this.cart.findIndex(product => product.name === productToCart.name);
    ...
    showProductsInHeader: function () {
      ...
      if (this.cart.length <= 0) {
        ...
        productsInHeader = this.cart.map(product => {
          return `
            <div>${product.name} Price: ${this.formatPrice(product.price)} Qty: ${product.qty} Subtotal: ${this.formatPrice(product.subtotal)}</div>
          `;
        }).join("");
      }
